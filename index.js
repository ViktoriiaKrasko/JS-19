...
console.log(!Object.isPrototypeOf(Book)); // Виводимо в консоль прототип Об'єкту: Book
...
Textbook.read = function () {
  return `Ви читаєте підручник "${this.title}" від ${this.author}. Про книгу "${this.title}": ${this._info}`;
...
const Song = Object.create(Media); // Створюємо об'єкт Song, наслідуємо властивості і функції від об'єкта Media
